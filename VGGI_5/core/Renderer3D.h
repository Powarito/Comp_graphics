...
public:
    ...
    // Create mesh with positions and normals (for lit surface)
    // Vertex format: pos(3) + normal(3) = 6 floats per vertex
    ...
    // Create simple mesh with positions and colors (for lines, axes, light indicator)
